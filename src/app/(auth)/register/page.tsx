...
import { Mail, Lock, User, CheckCircle2, ChevronRight, Eye, EyeOff } from 'lucide-react'
      ...
      <div className="hidden lg:flex flex-1 flex-col justify-between p-12 relative overflow-hidden bg-gradient-to-br from-navy-900 via-cyan-900/20 to-navy-900">
        ...
        <div className="relative z-10">
          <Link href="/" className="flex items-center gap-2.5">
            <Logo size={40} />  <span className="font-bold text-lavender-950 text-xl">AI Interview Coach</span>
          </Link>
        </div>
